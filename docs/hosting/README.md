...
| `SB_ENABLE_DEV_TOOLS` | No       | Set to `1` to enable the dev fake clock on a staging/demo instance (see [ADR 0004](../adr/0004-dev-fake-clock.md)). Leave unset in production |

...
- **Proposal search matches the description as it is shown**: searching a phrase that happens to be bold or italic in a proposal's description found nothing, because the search looked at the formatting marks around the words rather than the words themselves. Searching a phrase read straight off the screen now finds the proposal it came from
